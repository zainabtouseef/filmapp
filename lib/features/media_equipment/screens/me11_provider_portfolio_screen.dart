...
/// `profile_type: 'equipment'`.
class ME11ProviderPortfolioScreen extends StatefulWidget {
  const ME11ProviderPortfolioScreen({super.key});

  @override
  State<ME11ProviderPortfolioScreen> createState() =>
      _ME11ProviderPortfolioScreenState();
}

class _ME11ProviderPortfolioScreenState
    extends State<ME11ProviderPortfolioScreen> {
    ...
    return Column(
      ...
      children: [
        ...
        const PastRolesSection(
          ...
          emptyMessage:
              'Add past projects this gear was used on and a cover photo.',
        ),
      ],
    );
  }
    ...
    if (error is ApiException) {
      return switch (error.code) {
        ...
        'validation.invalid' => error.fields['file_id']?.join(' ') ??
            'Complete your provider profile before adding portfolio media.',
        'network.offline' =>
