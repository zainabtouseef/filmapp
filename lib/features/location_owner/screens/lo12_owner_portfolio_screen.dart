...
/// `profile_type: 'location'`. This is the owner's general portfolio —
/// separate from a specific property's published listing photos.
class LO12OwnerPortfolioScreen extends StatefulWidget {
  const LO12OwnerPortfolioScreen({super.key});

  @override
  State<LO12OwnerPortfolioScreen> createState() =>
      _LO12OwnerPortfolioScreenState();
}

class _LO12OwnerPortfolioScreenState extends State<LO12OwnerPortfolioScreen> {
    ...
    if (error is ApiException) {
      return switch (error.code) {
        ...
        'validation.invalid' => error.fields['file_id']?.join(' ') ??
            'Complete your owner profile before adding portfolio media.',
        'network.offline' =>
